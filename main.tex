...
(88.6\% of \lignee{L4.11}) and is defined by 44~near-core-exclusive markers
(Table~\ref{tab:l4112}).
...
\textit{rplC} (50S ribosomal protein~L3, a linezolid target).
...
and long-term macrophage survival),
...
intracellular survival, complementing the Mce1 import perturbation.

\textit{DNA replication fidelity.}  The \textit{dnaE1} mutation
targets the $\alpha$ subunit of DNA polymerase~III, the primary
replicase.  Alterations in replicative fidelity could influence
...
\lignee{L4.11.2} (731~SRAs, 44~near-core-exclusive markers) --- substantially
