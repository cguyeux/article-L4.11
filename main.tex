...
remains plausible and testable through phenotypic characterisation~\cite{safi2019}.
...
unvalidated.  Notably, 112~SRAs in our dataset originate from the
CRyPTIC consortium (PRJEB41199 and PRJEB76547), for which quantitative
MIC data across 13~antibiotics --- including bedaquiline and
ethambutol --- have been published~\cite{cryptic2022}.  Cross-referencing
our genotypic predictions with these phenotypic data would provide a
direct validation opportunity without requiring new laboratory work.
We invite laboratories with access to \lignee{L4.11} clinical isolates
to validate the key predictions of this study --- particularly the
hypothesised intrinsic ethambutol resistance in \lignee{L4.11.2} and
the silenced bedaquiline phenotype of \textit{mmpR5}~Ile67fs carriers
--- through phenotypic drug susceptibility testing.
